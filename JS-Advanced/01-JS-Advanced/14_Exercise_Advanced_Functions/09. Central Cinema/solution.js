function solve() {
    ...
    function onScreenHandler(e) {
        ...
        if (name.trim() !== '' &&
            ...
            //3a Attach event listener aech movie's archive button
    ...
    //3. Implement Add movie functionality
    function archiveMovie(e) {
        ...
        if (ticketsSold !== '' &&
            ...
            //3d create html structure for archive movie
            ...
            //4a Attach event listener aech movie's delete button
    ...
    function deleteFromArchive(e) {
        ...
        //4b delete html structure to a deleted movies from DOM
        movieLi.remove();
    ...
    function clearArchive() {
        //5b delete archive's LI elements from DOM
