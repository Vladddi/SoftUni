...
//        Connector.createConnection(ROOT, PASSWORD, SQL_DB);
...
//
        ...
        //final EntityManager<User> entityManager = new EntityManager<>();
//        final EntityManager<Account> accountEntityManager = new EntityManager<>();
//
//
//      //  Account account = new Account("Vladislav", LocalDate.now(), 43);
